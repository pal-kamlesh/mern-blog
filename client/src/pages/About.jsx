      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          <h1 className="text-3xl font-semibold text-center my-7">
            About Kamlesh&rsquo;s Blog
          </h1>
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Kamlesh&rsquo;s Blog! This blog was created by Sahand
            ...
            <p>
              On this blog, you&rsquo;ll find weekly articles and tutorials on
            ...
            <p>
              ...
              other readers. You can like other people&rsquo;s comments and
